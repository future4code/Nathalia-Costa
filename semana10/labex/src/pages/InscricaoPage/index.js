...
const IncricaoPage = (props) => {
  ...
  const fazerInscricao = () => {
    ...
    axios
      .post(
        `https://us-central1-labenu-apis.cloudfunctions.net/labeX/nathalia-julian/trips/${form.id}/apply`,
        body,
        {
    ...
    <InscricaoContainer>
      ...
      <CardInscricao>
        ...
        <InputInscricao
          ...
          inputProps={{
            pattern: "[A-Za-z]{3, }",
            title: "A descrição deve conter 3 letras no mínimo",
          }}
        ...
        <InputInscricao
          ...
          inputProps={{
              min: '18',
              pattern: "[1-9]{2, }",
              title: "Só para maiores de 18 anos"
          }}
          onChange={onChangeValor}
          required={true}
        ></InputInscricao>
        ...
        <InputInscricao
          ...
          name="descricao"
          label="Porque você deveria ir nessa viagem?"
          inputProps={{
            pattern: "[A-Za-z ]{30, }",
